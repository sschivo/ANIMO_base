...
//			boxScenarioAllParameters.add(boxScenarioParameters);
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i=0;i<paramFields.length;i++) {
						if (paramFields[i] instanceof LabelledField) {
							...
							JComboBox listE1act = (JComboBox)(e1Box.getComponent(1)),
									  listE1 = (JComboBox)(e1Box.getComponent(2)),
									  listE2act = (JComboBox)(e2Box.getComponent(1)),
									  listE2 = (JComboBox)(e2Box.getComponent(2));
					...
					edgeAttrib.setAttribute(edge.getIdentifier(), UNCERTAINTY, 5); //uncert);
	...
	private void updateParametersBox(Edge edge, Box parametersBox, Scenario selectedScenario, int increment) {
		...
		if (currentlySelectedScenario == 0) {
			...
			final JComboBox listE1 = new JComboBox(reactantAliases),
							listE2 = new JComboBox(reactantAliases),
							listE1act = new JComboBox(activeInactive),
							listE2act = new JComboBox(activeInactive);
